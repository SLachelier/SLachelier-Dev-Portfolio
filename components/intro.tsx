  ...
  return (
    <section ref={ref} id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[30rem]'>
      ...
      <motion.h1 className='mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-4xl' initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        <span className='font-bold'>Hello, I'm Shauna.</span> I am a <span className='font-bold'>full-st ack developer</span> with <span className='font-bold'>three years</span> of experience developing projects. <br/>I specialize in <span className='font-bold'>React (Next.js).</span>
      </motion.h1>
